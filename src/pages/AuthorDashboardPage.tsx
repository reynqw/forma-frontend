...
export default function AuthorDashboardPage() {
  ...
  const resourcesTotalPages = resourcesData?.data?.totalPages ?? 0
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <PageHead title="Дашборд автора" />
      <Breadcrumbs items={[{ label: 'Дашборд автора' }]} />
      ...
      {rLoading ? (
        ...
        <>
          ...
          <div className="mt-6">
            <Pagination page={resourcesPage} totalPages={resourcesTotalPages} onPageChange={setResourcesPage} />
          </div>
        </>
      )}
    </div>
