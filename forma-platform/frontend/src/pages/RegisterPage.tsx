    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-surface-100 px-4">
        <div className="w-full max-w-md text-center animate-scale-in">
          <div className="bg-white rounded-2xl shadow-card-lg p-10">
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900">
      ...
      <div className="hidden lg:flex lg:w-[45%] relative overflow-hidden">
        {/* Floating orbs */}
        <div className="absolute -top-20 -left-20 w-80 h-80 bg-primary-400/30 rounded-full blur-3xl animate-float" />
        <div className="absolute top-1/4 right-0 w-60 h-60 bg-primary-300/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }} />
        <div className="absolute bottom-10 left-1/3 w-72 h-72 bg-primary-500/25 rounded-full blur-3xl animate-float" style={{ animationDelay: '4s' }} />
        <div className="absolute top-1/2 left-10 w-40 h-40 bg-white/5 rounded-full blur-2xl" />
